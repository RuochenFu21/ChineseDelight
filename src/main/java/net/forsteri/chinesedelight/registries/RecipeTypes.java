...
import net.forsteri.chinesedelight.contents.foods.fillable.dumplings.recipes.DumplingBoilingRecipe;
import net.forsteri.chinesedelight.contents.foods.fillable.dumplings.recipes.DumplingCraftingRecipe;
...
public enum RecipeTypes {
    ...
    RecipeTypes(Supplier<RecipeSerializer<?>> serializerSupplier, Supplier<RecipeType<?>> typeSupplier, boolean registerType) {
        ...
        id = new ResourceLocation(ChineseDelight.MOD_ID, name);
    ...
    private static class Registers {
        private static final DeferredRegister<RecipeSerializer<?>> SERIALIZER_REGISTER = DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, ChineseDelight.MOD_ID);
        private static final DeferredRegister<RecipeType<?>> TYPE_REGISTER = DeferredRegister.create(Registry.RECIPE_TYPE_REGISTRY, ChineseDelight.MOD_ID);
    }
