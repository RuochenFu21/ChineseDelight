...
public class OtherRegistries {
    ...
    public static RegistryObject<SimpleRecipeSerializer<DumplingCraftingHandler>> CUSTOMIZED_COOKING = register("customize_cooking", new SimpleRecipeSerializer<>(DumplingCraftingHandler::new));

    public static RegistryObject<SimpleRecipeSerializer<DumplingCraftingHandler>> DUMPLING_BOILING = register("dumpling_boiling", new SimpleRecipeSerializer<>(DumplingCraftingHandler::new));
